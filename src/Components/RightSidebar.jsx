...
export default function RightSidebar(){
  return (
    <>
  <div className="absolute hidden right-0 bottom-[10%] overflow-auto top-[89px] -z-10 lg:flex flex-col bg-clip-border rounded-xl text-white w-60 p-4 shadow-xl shadow-blue-gray-900/5" style={{backgroundColor:"#1B0025"}}>
